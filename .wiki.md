# Project Summary
The project is a web application that monitors and analyzes extractive activities in the Puglia region of Italy. It provides dynamic visualizations and insights into authorized caves, allowing users to input data manually or upload simplified Excel files. This application enhances transparency and supports data-driven decision-making in the extractive sector, making it a valuable tool for stakeholders.
